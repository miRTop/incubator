...
names(complete) = gsub("_tagMir-all", "", names(complete))
...
dds$samples %>% as.data.frame() %>% 
    ...
    write_csv("tables/dispersion/isomirsea.lib.size.csv")
...
full %>% 
    ...
    write_csv("tables/dispersion/isomirsea.csv")
