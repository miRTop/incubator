...
cd bcbio
	...
	mirtop stats -o stats mirtop/*ready.gff
	mirtop counts --gff mirtop/mirtop.gff --out mirtop --hairpin ../../reference/hairpin.fa --gtf ../../reference/mirbase.gff3 --add-extra --sps hsa
cd ..
...
cd isomirsea
	...
	mirtop stats -o mirtop mirtop/*all.gff
...
cd srnabench
	...
	mirtop gff --hairpin ../../reference/hairpin.fa --gtf ../../reference/mirbase.gff3  -o mirtop --sps hsa --format gff */mirtop.gff
	mirtop counts --gff mirtop/mirtop.gtf --out mirtop --hairpin ../../reference/hairpin.fa --gtf ../../reference/mirbase.gff3 --add-extra --sps hsa
cd ..
